...
test('PropertyTaxNoDueCertificate', async ({ page }) => {
  test.setTimeout(0);
  // Read Excel
  ...
  await page.getByRole('link', { name: 'Property Tax - No Dues' }).click();
  ...
  await page.locator('#finacialYearId0').selectOption('100000044');
